...
public:
	...
	virtual void OnInit()
	{
      ...
      Modelo3D[0]->AbrirMalla("./Mallas/house_01.obj");

      Modelo3D[1] = new Objeto3D();
      Modelo3D[1]->AbrirMalla("./Mallas/housemedieval.obj");

      Modelo3D[2] = new Objeto3D();
      Modelo3D[2]->AbrirMalla("./Mallas/metro.obj");
